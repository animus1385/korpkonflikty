    ...
    <section class="blog-list" itemscope itemtype="http://schema.org/Blog" id="blog-list" v-if="props?.data.fields">
        <div class="blog-list__container container">
            ...
            <ul class="blog-list__list">
                <li
                    class="blog-list__elem"
                    v-for="elem in storeBlog.items"
                    itemprop="blogPosts"
                    itemscope
                    ...
                    <NuxtLink :to="elem.node.uri" NuxtImg class="blog-list__image-blog" :aria-lavel="elem.node.title">
                        <div class="blog-list__top">
                            <NuxtImg
                                ...
                                loading="lazy"
                                format="webp"
                                class="blog-list__picture"
                                :src="
                                    elem.node.featuredImage.node.webpSourceUrl
                                        ? elem.node.featuredImage.node.webpSourceUrl
                                        : elem.node.featuredImage.node.sourceUrl
                                "
                                :alt="elem.node.title"
                            />
        ...
        <UPagination
            v-if="storeBlog.items.length > storeBlog.postsPerPage"
            class="blog-list__pagination"
            v-model="storeBlog.page"
            :page-count="storeBlog.postsPerPage"
            :total="storeBlog.totalCount"
